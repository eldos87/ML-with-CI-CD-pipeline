...
class Configuration:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            artifact_dir = self.training_pipeline_config.artifact_dir    # root/housing/artifact
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            artifact_dir = self.training_pipeline_config.artifact_dir
            data_transformation_artifact_dir = os.path.join(artifact_dir, DATA_TRANSFORMATION_ARTIFACT_DIR_NAME,
                                                            self.time_stamp)
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            trained_model_file_path = os.path.join(model_trainer_artifact_dir,
                                                   ...
                                                   model_trainer_info[MODEL_TRAINER_FILE_NAME_KEY])

            base_accuracy = model_trainer_info[MODEL_TRAINER_BASE_ACCURACY_KEY]

            model_config_file_path = os.path.join(model_trainer_info[MODEL_TRAINER_CONFIG_DIR_KEY],
                                                  model_trainer_info[MODEL_TRAINER_CONFIG_FILE_NAME_KEY])
